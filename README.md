...
| `chart_before_after_cleaning.png` | Chart 4 (additional) — raw vs cleaned overlay; the corrupted mean and the 999-spike vanish visibly |
| `chart_misleading_vs_honest.png` | Chart 5 (additional) — truncated vs full y-axis on the same data (quiz Q8 demonstrated) |
| `chart_channel_mix_unknown.png` | Chart 6 (additional) — intake mix with the 4.8% Unknown gap kept visible |
